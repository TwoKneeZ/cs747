...
# ADDED CLASS WEIGHTS AND REGULARIZATION, INCEPTION_V3
# In[2]:
...
left_model = init_model().to(device)
left_optimizer = optim.Adam(left_model.parameters(), lr=1e-4, weight_decay=1e-2)
...
right_model = init_model().to(device)
right_optimizer = optim.Adam(right_model.parameters(), lr=1e-4, weight_decay=1e-2)
