...
left_optimizer = optim.Adam(left_model.parameters(), lr=1e-4)
left_criterion = nn.CrossEntropyLoss()
...
right_optimizer = optim.Adam(right_model.parameters(), lr=1e-4)
right_criterion = nn.CrossEntropyLoss()
